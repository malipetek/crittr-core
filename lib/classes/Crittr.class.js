...
class Crittr {
    ...
    validateOptions() {
        ...
        if(!this.options.browser) {
            throw new Error('Please provide a puppeteer browser instance to browser setting. It is mandatory in this version.');
        }
    ...
    async getBrowser() {
        try {
            if (this.options.puppeteer.browser !== null) {
                ...
                throw new Error('Please provide browser instance in the options');
            }
        } catch (e) {
            throw new Error(e);
        }
